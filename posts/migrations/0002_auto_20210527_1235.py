...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('categories', '0002_alter_categories_name_category'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='category_post',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='categories.categories', verbose_name='Categoria'),
        ),
        migrations.AlterField(
            model_name='post',
            name='content_post',
